...
template <>
const char *TerrainHeightFractal<TerrainHeightMapped3>::GetHeightFractalName() const { return "Mapped"; }

template <>
TerrainHeightFractal<TerrainHeightMapped3>::TerrainHeightFractal(const SBody *body) : Terrain(body)
{
}
...
//	}
...

	{
		...
		h += 30000.0*v*v*v*v*v*v*v*octavenoise(16, 5.0*v, 20.0*v, p);
		h += v;
		h -= 0.09;
