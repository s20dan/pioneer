...
LUA_MEMBER_FUNC_9(OOLUA::Proxy_class<CustomSBody>, rotation_period, axial_tilt, height_map, metallicity, ore_abundance, volcanicity, atmos_density, atmos_oxidizing, ocean_cover)
