...
DECLARE_STRING(MINING_MACHINE);
DECLARE_STRING(MINING_MACHINE_DESCRIPTION);
DECLARE_STRING(MINING_MESSAGE);
DECLARE_STRING(MINING_WARNING);
DECLARE_STRING(MINING_SUCCESS);
DECLARE_STRING(MINING_FAILURE);
DECLARE_STRING(MINING_WORTHLESS);
...
DECLARE_STRING(CRUST_COMP);
DECLARE_STRING(CRUST_DESC1);
DECLARE_STRING(CRUST_DESC2);
DECLARE_STRING(CRUST_DESC3);
DECLARE_STRING(CRUST_DESC4);
DECLARE_STRING(CRUST_DESC5);
DECLARE_STRING(CRUST_DESC6);
